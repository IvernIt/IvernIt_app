...
public class ClienteTemperatura {
  ...
  public ClienteTemperatura(String num) {
    client = javax.ws.rs.client.ClientBuilder.newClient();
    String resourcePath = java.text.MessageFormat.format("parameters/temperatura/{0}", new Object[]{num});
   ...
   */
  public <T> T putTemperatura(Class<T> responseType) throws ClientErrorException {
